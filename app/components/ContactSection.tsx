	...
	return (
		<section className="py-12 md:py-20 px-4">
			<div className="max-w-3xl mx-auto text-center">
				...
				>
					<a href="https://github.iu.edu/namcbrid" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/5 rounded-full hover:bg-white/10 transition-colors">
					...
					<a href="https://www.linkedin.com/in/nicholas-mcbride-471296259/" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/5 rounded-full hover:bg-white/10 transition-colors">
						<svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
